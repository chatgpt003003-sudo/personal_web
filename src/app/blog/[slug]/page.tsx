    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          {/* Main Content */}
          <main className={tableOfContents.length > 0 ? 'lg:col-span-9' : 'lg:col-span-12'}>
            {/* Excerpt */}
            {post.excerpt && (
            ...
            <article className="prose prose-invert prose-lg max-w-none">
              <ReactMarkdown
                ...
                components={{
                  ...
                  h2: ({ children, ...props }) => (
                    <h2 className="text-2xl font-bold mb-4 mt-8 text-white" {...props}>
                      {children}
                    </h2>
                  ),
                  h3: ({ children, ...props }) => (
                    <h3 className="text-xl font-bold mb-3 mt-6 text-white" {...props}>
                      {children}
                    </h3>
                  ),
                  p: ({ children, ...props }) => (
                  ...
                  pre: ({ children, ...props }) => (
                    <pre className="bg-gray-900 rounded-lg p-4 overflow-x-auto mb-6" {...props}>
                      {children}
                    </pre>
                  ),
                  blockquote: ({ children, ...props }) => (
                    <blockquote className="border-l-4 border-red-500 pl-4 italic text-gray-300 mb-6" {...props}>
                      {children}
                    </blockquote>
                  ),
                  ul: ({ children, ...props }) => (
